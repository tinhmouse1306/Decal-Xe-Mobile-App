...
data class TechLaborPriceDto(
    @SerializedName("laborPriceID")
    val laborPriceID: String,
...
data class UpdateTechLaborPriceDto(
    @SerializedName("laborPrice")
    val laborPrice: Double?
)
...
data class UpdateVehicleDecalTypePriceDto(
    @SerializedName("price")
    val price: Double
)
...
data class CreateOrderWithCustomerDto(
    ...
    @SerializedName("newCustomerPayload")
    val newCustomerPayload: NewCustomerPayloadDto?
)
...
data class OrderCreateFormDataDto(
    ...
    val customers: List<CustomerFormDto>,
    
    @SerializedName("services")
    val services: List<ServiceFormDto>,
    
    @SerializedName("employees")
    val employees: List<EmployeeFormDto>
)
...
data class OrderTrackingDto(
    ...
    @SerializedName("stageHistory")
    val stageHistory: List<OrderStageHistoryDto>
)
...
data class ScheduledWorkUnitDto(
    ...
    @SerializedName("assignedTechnicianName")

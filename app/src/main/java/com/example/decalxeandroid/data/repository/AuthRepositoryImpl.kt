...
class AuthRepositoryImpl(
    ...
    override suspend fun register(
        ...
        return try {
            ...
            val registerRequest =
                    RegisterMobileRequestDto(fullName, username, email, password, confirmPassword)
        ...
        return try {
            val changePasswordRequest =
                    ChangePasswordRequestDto(
                            ...
                            newPassword,
                            newPassword
                    ) // Use newPassword as confirmPassword
        ...
        return try {
            val resetPasswordRequest =
                    ResetPasswordRequestDto(
                            ...
                            "",
                            ""
                    ) // Empty strings for newPassword and confirmPassword
